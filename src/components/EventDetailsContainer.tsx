...
export const EventDetailsContainer = ({ event }: EventDetailsContainerProps) => {
  ...
  return (
    <>
      ...
      >
        {/* Hero Image */}
        <div className="relative h-[400px] rounded-xl overflow-hidden modern-shadow">
          <img
