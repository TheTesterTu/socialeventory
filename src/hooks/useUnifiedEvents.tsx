...
export const useUnifiedEvents = ({
  ...
  return useQuery({
    queryKey: ['unified-events-v3', { searchQuery, category, featured, limit, sortBy, sortOrder }],
      ...
      try {
        ...
        return data.map(dbEvent => {
          try {
            ...
            console.warn('Event mapping error:', mappingError, 'Event:', dbEvent);
            return {
    ...
    staleTime: 60 * 1000, // 1 minute - better caching
